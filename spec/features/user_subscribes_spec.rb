...
RSpec.feature "User subscribes", type: :feature, js: true do
  ...
  describe "When the user visits the splash view" do
    
    background do
      visit('/')
    end
      
    it "can see an invitation to subscribe" do
    ...
    it "can be guided to the subscribe form after clicking on the subscribe button" do
    ...
    it "can return from the subscribe form to the splash screen" do
      click_link('Subscribe')
      expect(page).to have_current_path('/subscribe')
  ...
  describe "When the user is on the subscribe view" do
    
    background do
      visit('/subscribe')
    end
    
    context "as she fills in the form fields" do
    
      it "sees a message error on the e-mail field as long as the provided email is in a wrong format" do
      ...
      it "sees a message error on the phone number field as long as the provided phone number is in a wrong format" do
      ...
      it "sees a message error on the zipcode field as long as the provided zipcode is in a wrong format" do
